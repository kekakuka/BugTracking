...
@section('content')
    ...
    <div id="print" style="padding: 0% 10%;">
        <div style="background-color:white;width: 100%; border: 1px solid darkgray; border-radius: 10px;">
            <div style="margin: 0 2%; width: 96%;font-family: 'Times New Roman'; padding: 0 5%;" class="row">
                <br>
                            ...
                            @foreach($subsystem->bugs($moreThanDate,$lessThanDate) as $Bug)
                                ...
                                <tr><td colspan="8">
                                        <div  class="box">
                                            ...
                                            <div class="overbox">
                                                <div class="tagline overtext">Test Description: {{$Bug->test->testcase->description }}<br>  Usecase: {{$Bug->test->testcase->usecase->name }}<br></div>
